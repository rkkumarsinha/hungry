...
// Set width for inputs in horizontal search bar -----------------------------------------------------------------------
    ...
    $( "#redefine-search-form" ).load( "http://test.com/hungry/assets/external/_search-bar.html", function() {
        setInputsWidth();
        //autoComplete();
    });
...
function autoComplete(){
    if( !$("script[src='http://test.com/hungry/assets/js/leaflet.js']").length ){
...
function rating(){
    $(".hungry-star-wrapper > input").rating({
        disabled:true,
        showClear:false,
        showCaption:false,
        hoverEnabled:false,
...
function drawOwlCarousel(_rtl){
    $.getScript( "http://test.com/hungry/assets/js/owl.carousel.min.js", function( data, textStatus, jqxhr ) {
        ...
        if( category == 'real_estate' ){
            if( json.data[a].item_specific ){
                if( json.data[a].item_specific.bedrooms ){
                    itemSpecific += '<span title="Bedrooms"><img src="http://test.com/hungry/assets/img/bedrooms.png">' + json.data[a].item_specific.bedrooms + '</span>';
                }
                ...
                if( json.data[a].item_specific.area ){
                    itemSpecific += '<span title="Area"><img src="http://test.com/hungry/assets/img/area.png">' + json.data[a].item_specific.area + '<sup>2</sup></span>';
                }
