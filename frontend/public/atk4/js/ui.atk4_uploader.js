...
$.widget("ui.atk4_uploader", {
	...
	upload: function(){
		...
		var g=$('<div class="atk-loader hungry-image-preuploading" id="'+this.name+'_progress"><i></i><img style="width:30px;" src="images/uploading.gif"/>Uploading '+this.element.val()+'</div>')
