...
class endpoint_v1_post_paidbookedticket extends HungryREST {
    ...
    */
    ...
    function put_post($data){
        ...
        $return_array = $m->paidBookedTicket($data['ticket_booking_no'],$this->api->auth->model->id,$data['amount_paid'],$data['payment_mode']);
    ...
    function validateParam($data){
        $required_param = ['ticket_booking_no','amount_paid','payment_mode','transaction_detail'];
